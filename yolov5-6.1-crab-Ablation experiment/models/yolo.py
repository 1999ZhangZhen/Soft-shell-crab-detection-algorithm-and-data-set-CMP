...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,
                 ...
                 CA, CABottleneck, C3CA, SE, ODConv2d, CBAM, CBAMMA
                 ]:
            c1, c2 = ch[f], args[0]
        ...
        #     args = [c2]
            ...
            args = [*args[:]]
        elif m in [ShuffleAttention, MHSA]:
            c1 = ch[f]
            args = [c1, *args[0:]]
        ...
        # ------------------FasterNet----------------------
            ...
            c1 = ch[f]
            args = [c1, *args[0:]]
        elif m is MconvNetBlock:
            c1 = ch[f]
            args = [c1, *args[0:]]
        elif m is SMconvNetBlock:
            c1 = ch[f]
            args = [c1, *args[0:]]
        elif m is ODC:
            c1 = ch[f]
            ...
            c1 = ch[f]
            args = [c1, *args[0:]]
        # elif m is JointBlocK:
        #     c1 = ch[f]
        #     args = [c1, *args[0:]]
        # elif m is PDSNet_Blk:
        #     c1 = ch[f]
        #     args = [c1, *args[0:]]
        elif m is PConv2d:
            c1 = ch[f]
...
def forward(self, x):
    ...
    return torch.cat((b.view(bs, self.na, 5, ny, nx), c.view(bs, self.na, self.nc, ny, nx)), 2).view
