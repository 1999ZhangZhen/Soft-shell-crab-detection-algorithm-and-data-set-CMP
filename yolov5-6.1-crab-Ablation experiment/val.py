...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/Baseline Selection/yolov5n/weights/best.pt', help='model.pt path(s)')
    ...
    opt.data = check_yaml(opt.data)  # check YAML4
